...
function MainPage({ props }) {
  const {
    ...
    BwindClub,
    BwindMarkect,
    backgroundResponsiveBwindiClub,
    backgroundResponsiveMarketplace,
  } = props;
          ...
          <div className="imageBoxRow row">
            <div className="imageCol">
              <div className="overlap-group2">
                <img className="image_responsive" src={backgroundResponsiveBwindiClub}></img>
                <video className="video_responsive" loop="true" autoplay="autoplay" muted>
            ...
            <div className="imageCol">
              <div className="overlap-group3">
                <img className="image_responsive" src={backgroundResponsiveMarketplace}></img>
                <video className="video_responsive" loop="true" autoplay="autoplay" muted>
            ...
            <div className="flex-row-1 socialSbuscrib">
              ...
              <div className="footSubscrib">
                <p className="stay-tuned-for-more valign-text-middle jost-semi-bold-white-15px">
                  Staay tuned for more details by subscribing to our newsletter!
                </p>
